...
```{r Prepare workspace}
#1. 
library(tidyverse);library(sf);library(leaflet);library(mapview);library(ggplot2)
...
Counties <- st_read('C:/Users/ardwh/OneDrive/Documents/NSOE/env872/EDA-Spring2023/Data/Spatial/cb_2018_us_county_20m.shp')
mapview(Counties)
