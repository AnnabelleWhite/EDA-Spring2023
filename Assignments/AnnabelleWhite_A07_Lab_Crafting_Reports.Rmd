...
: Table 1: EPA Air Quality metadata
...
kable(summary_PM25, # Set dataset
      col.names = c("County","$\\mu g/m^3$"), # Column names
      align = c('r','l'), # Align columns
      caption = "Table 2: Mean Particulates (2.5mm)") # Title table
kable(summary_Ozone, # Set dataset
      col.names = c("County","$\\mu g/m^3$"), # Column names
      align = c('r','l'), # Align columns
      caption = "Table 3: Mean Ozone") # Title table
...
```{r Ozone 2018, echo = FALSE, fig.align='left', fig.width=10, fig.height=4, fig.cap="Monthly Ozone, 2018"}
#Make boxplot for monthly ozone in 2018
boxplot(Ozone ~ Month, 
        epa_data,
        epa_data$Year == 2018, #Subset to data from 2018
        xlab = "Month", 
        ylab = "Ozone")
```

```{r Ozone 2019, echo = FALSE, fig.align='left', fig.width = 10, fig.height=4, fig.cap="Monthly Ozone, 2019"}
#Make boxplot for monthly ozone in 2019
boxplot(Ozone ~ Month, 
        epa_data,
        epa_data$Year == 2019, #Subset to data from 2019
        xlab = "Month", 
        ylab = "Ozone")
```
...
<https://github.com/AnnabelleWhite/EDA-Spring2023>
