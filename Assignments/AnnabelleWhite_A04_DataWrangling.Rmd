...
# I could not stand the redundancy of doing each command 4x in a row
# So I made pipes for each dataset
# If I had more time I'd want to make a function and apply it to each
...
EPA.air.processed <- 
  ...
  summarize(AQI.Mean = mean(DAILY_AQI_VALUE), # Find means of these fields
...
#10
glimpse(EPA.air.processed) # Shows dimensions of dataset
